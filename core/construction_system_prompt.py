...
def _texte_actions_application(actions):
    ...
    instruction = (
        ...
        "- Quand une fenêtre, une popup ou un menu est ouvert par dessus la page, seuls ses éléments "
        "apparaissent dans la liste : tout ce qu'elle recouvre est absent, inutile de le chercher. "
        "Pour agir sur la page en dessous, ferme d'abord la fenêtre (bouton fermer, annuler, retour ou "
        "croix de la liste). Si un clic te répond qu'un élément est masqué, fais de même.\n"
