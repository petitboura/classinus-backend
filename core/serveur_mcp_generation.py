...
uniquement un déplacement de code :
  ...
  - outils_signalements.py       : discussion prof/LLM sur un
    signalement pédagogique, note de synthèse, rattachement matière/
    notion (refonte du 10/09/2026)
...
import core.outils_commentaires_catalogue_public  # noqa: F401
import core.outils_programme_catalogue_public  # noqa: F401  # 22/09/2026, catalogue public du Programme
